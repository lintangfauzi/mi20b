<?php 
    $kota = "Tasikmalaya";
    $nomor = "202002051";
    $barang = array('kulkas', 'TV', 'Buku', 'Laptop','komputer');
...
<body>
    <?php
        ...
        echo "<br>";
        echo "Pada hari kemarin saya telah meminjam beberapa barang dari PT Sejahtra abadi. saya meminjam tanpa memberikan izin resmi terlebih dahulu.";
        echo "<br>";
        ...
        echo "<br>";
        echo "Saya ucapkan terimakasih , semoga kita selalu di beri kesehatan dan dilindungi oleh alloh.";
        echo "<br>";
        echo "<br>";
        echo "<br>";
        echo $kota;
